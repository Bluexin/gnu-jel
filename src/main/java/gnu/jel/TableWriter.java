...
public class TableWriter {
    ...
    public static void main(String[] args) {
        ...
        final Path outputFile = Paths.get(args[0], "gnu/jel/tables.dat");
        if (Debug.enabled) {
            try {
...
//            Debug.println("specialClasses["+j+"]="+specialClasses[j]);
                ...
                int[][] una = {
                        ...
                        {0x57FA, 0x57, 0x57, 0x57, 0x57, 0x58, 0x57, 0x58, 0x57, 0xFF, 0x57, 0x57},//VOID|13
                ...
                //  --------- WRITING CODE
                final var unused = outputFile.getParent().toFile().mkdirs();
